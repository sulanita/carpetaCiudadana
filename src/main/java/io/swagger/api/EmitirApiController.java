...
@RestController
public class EmitirApiController implements EmitirApi {

    private static final Logger log = LoggerFactory.getLogger(EmitirApiController.class);
    ...
    public EmitirApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<PaqueteDocumentacion> emitirDocumentoPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody RequestPedirDocumentos body) {
