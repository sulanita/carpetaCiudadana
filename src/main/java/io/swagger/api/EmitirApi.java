...
@Validated
public interface EmitirApi {

    @Operation(summary = "Emitir el documento solicitado por el usuario", description = "", tags={ "Entidad" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/emitir/documento",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<PaqueteDocumentacion> emitirDocumentoPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody RequestPedirDocumentos body);
